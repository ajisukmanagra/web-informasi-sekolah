...
<header class="pt-3 border-bottom">
    <div class="container pt-md-1 pb-md-1">
        <h3 class="bd-title mt-3 mb-4 font-weight-bold" style="color: #0004ff;"><i class="fas fa-trophy" aria-hidden="true"></i> NILAI ONLINE</h3>
    </div>
</header>

<nav aria-label="breadcrumb" style="background:#0004ff;color:#fff;">
    <div class="container">
