...
<header class="pt-3 border-bottom">
    <div class="container pt-md-1 pb-md-1">
        <h3 class="bd-title mt-3 mb-4 font-weight-bold" style="color: #0026ff;"><i class="fas fa-boxes" aria-hidden="true"></i> Struktur Organisasi</h3>
    </div>
</header>

<nav aria-label="breadcrumb" style="background:#0011ff;color:#fff;">
    <div class="container">
        <ol class="breadcrumb" style="background:#1100ff;color:#fff;">
